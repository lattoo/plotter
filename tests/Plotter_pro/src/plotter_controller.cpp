...
void PlotterController::setup_plot()
{
    ...
    _plotter->chart(CHART_ONE)->set_brush_color(Qt::red);
    _plotter->chart(CHART_ONE)->set_color_b(Qt::green);
    _plotter->chart(CHART_ONE)->set_brush_style(Qt::BrushStyle::LinearGradientPattern);

    _plotter->chart(CHART_TWO)->set_pen(QPen(CH_TWO_COLOR, PEN_WIDTH, PEN_STYLE));
    _plotter->chart(CHART_TWO)->set_brush_color(Qt::blue);
    _plotter->chart(CHART_TWO)->set_color_b(Qt::green);
    _plotter->chart(CHART_TWO)->set_brush_style(Qt::BrushStyle::LinearGradientPattern);

    _plotter->chart(CHART_THREE)->set_pen(QPen(CH_THREE_COLOR, PEN_WIDTH, PEN_STYLE));
    _plotter->chart(CHART_THREE)->set_brush_color(Qt::yellow);
    _plotter->chart(CHART_THREE)->set_color_b(Qt::green);
    _plotter->chart(CHART_THREE)->set_brush_style(Qt::BrushStyle::LinearGradientPattern);
