...
void PlotterController::setup_plot()
{
    ...
    _plotter->axes().ticks().x().set_enabled(true);
    _plotter->axes().ticks().x().set_tick_type(TICK_TYPE);
    _plotter->axes().ticks().x().set_length(TICK_SIZE);

    _plotter->axes().ticks().y().set_enabled(true);
    _plotter->axes().ticks().y().set_tick_type(TICK_TYPE);
    _plotter->axes().ticks().y().set_length(TICK_SIZE);

    _plotter->axes().ticks().sub_x().set_enabled(true);
    _plotter->axes().ticks().sub_x().set_tick_type(SUB_TICK_TYPE);
    _plotter->axes().ticks().sub_x().set_length(SUB_TICK_SIZE);

    _plotter->axes().ticks().sub_y().set_enabled(true);
    _plotter->axes().ticks().sub_y().set_tick_type(SUB_TICK_TYPE);
    _plotter->axes().ticks().sub_y().set_length(SUB_TICK_SIZE);

    _plotter->grid().x().set_enabled(true);
    _plotter->grid().y().set_enabled(true);
    _plotter->grid().sub_x().set_enabled(true);
    _plotter->grid().sub_y().set_enabled(true);
