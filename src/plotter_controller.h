...
class PlotterController : public QObject
{
    ...
    static constexpr uint8_t TICK_SIZE = 10;
    static constexpr TickType TICK_TYPE = TickType::INTERNAL_SINGLE_SIDED;
    static constexpr uint8_t SUB_TICK_SIZE = 5;
    static constexpr TickType SUB_TICK_TYPE = TickType::INTERNAL_SINGLE_SIDED;
